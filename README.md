...
+ Unterstützung aktueller CCU2 Firmware (ältere Versionen lassen sich nicht länger von der Homematic Seite runterladen, somit ist LXCCU aktuell leider unbenutzbar)
...
_(Die Einrichtung des HM-MOD-RPI-PCB erfolgt automatisiert ausschließlich auf dem Rapsberry Pi)_
...
Anschließend kann mit **sudo yahm-ctl start** der Container gestartet werden
...
### Updates
Mit **sudo yahm-ctl update** kann die YAHM Installation (nicht CCU2 Firmware) jederzeit aktualisiert werden. Für die Aktualisierung der CCU2 Installation, siehe [LXC Container](https://github.com/leonsio/YAHM/wiki/YAHM-LXC)
...
Für erfahrene Benutzer mit mehreren hundert Geräten/Programmen reicht die Leistung einer CCU2 nicht aus, für diese Zielgruppe wurde die Anwendung primär entworfen. Für unerfahrene Benutzer wird weiterhin empfohlen die CCU2 zu erwerben.
