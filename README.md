...
```
wget -nv -O- https://raw.githubusercontent.com/leonsio/YAHM/release_1.0/yahm-init | sudo -E  bash -s quickinstall -
```
...
```
wget -nv -O- https://raw.githubusercontent.com/leonsio/YAHM/master/release_1.0 | sudo -E  bash -
```
