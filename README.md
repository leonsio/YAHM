...
```
wget -nv -O- https://raw.githubusercontent.com/leonsio/YAHM/release_1.6/yahm-init | sudo -E  bash -s ui -
```
...
```
wget -nv -O- https://raw.githubusercontent.com/leonsio/YAHM/release_1.6/yahm-init | sudo -E  bash -
```
